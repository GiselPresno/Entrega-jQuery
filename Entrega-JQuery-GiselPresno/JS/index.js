...
const productos = [];
const carrito   = [];
const categorias = ["TARJETAS","CUADERNOS"];
...
productos.push(new Producto(1, "TARJETA1", 200, categorias[0]));
productos.push(new Producto(2, "TARJETA2", 300, categorias[0]));
productos.push(new Producto(3, "TARJETA3", 100, categorias[0]));
productos.push(new Producto(4, "TARJETA4", 350, categorias[0]));
productos.push(new Producto(5, "CUADERNO1", 600, categorias[1]));
